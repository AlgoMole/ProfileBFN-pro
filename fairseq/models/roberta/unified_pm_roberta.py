...
class UnifiedPMRobertaEncoder(FairseqEncoder):
    ...
    def extract_features(self, src_tokens, aa_mask=None, attn_bias=None, return_all_hiddens=False, token_dropout=True, need_head_weights=False, return_contacts=False, **kwargs):
        ...
        return features, {"inner_states": inner_states, "pair_rep" : encoder_out["pair_rep"][0], "x_norm" : encoder_out["x_norm"][0]}
