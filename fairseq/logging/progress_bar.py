...
class WandBProgressBarWrapper(BaseProgressBar):
    ...
    def __init__(
        self, wrapped_bar, wandb_project, run_name=None, wandb_dir=None, wandb_tags=None
    ):
        self.wrapped_bar = wrapped_bar
        if wandb is None:
        ...
        wandb.define_metric("cp_result/eval_step")
        wandb.define_metric("cp_result/*", step_metric="cp_result/eval_step")
