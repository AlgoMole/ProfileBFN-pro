...
class CommonConfig(FairseqDataclass):
    ...
    no_evaluation: bool = field(default=False, metadata={"help": "no evaluation flag"})
    ...
    wandb_tags: Optional[str] = field(
        default=None,
        metadata={"help": "wandb tags to identify the run"},
    )
...
class CheckpointConfig(FairseqDataclass):
    revision: str = field(default="", metadata={"help": "code revision"})
    save_dir: str = field(
